...
✅ _ take **3 numbers** as user inputs: month, day, and year
(e.g., if a user's birthday is June 12, 1990, they would enter `6 12 1990`)
✅ _ use the [horoscope](https://www.npmjs.com/package/horoscope) 3rd party module to determine:

✅ _ the **astrological sign** (e.g., Leo)
✅ _ the **zodiac sign** (e.g., Goat)
